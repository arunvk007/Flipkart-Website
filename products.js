var products=[
  ...
  products.forEach((item)=>{
    ...
    <div class="card-body">
      <button class="btn btn-success" onclick="fetchpro(event)" name="${item.id}">click here</button>
    </div>
  </div>
    `
  })
  ...
  function fetchpro(e){
    pid=e.target.name
    pro=products.find((item)=>item.id=pid)
    console.log(pro)
    display(pro)
  }                
  ...
  function display(i){
    ...
    <div class="modal-content">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">Rs:${i.price}</li>
        <li class="list-group-item">Rs:${i.rating.rate} (${i.rating.count})</li>
      </ul>
    </div>
